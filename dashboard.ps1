...
$Navigation = New-UDSideNav -Content {
    ...
    New-UDSideNavItem -Text "PowerShellOnLinux Group ( Element/Matrix )"  -OnClick { Invoke-UDRedirect -Url "https://matrix.to/#/!ftrCnWRocDJueqVraQ:matrix.org?via=matrix.org&via=poshcode.org&via=t2bot.io" -OpenInNewWindow }
